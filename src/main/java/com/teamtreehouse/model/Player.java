...
public class Player implements Comparable<Player>, Serializable {
    ...
    public int compareTo(Player other) {
        ...
        int results = this.lastName.compareTo(other.getLastName());
        if (results != 0) { return results; } else {
    ...
    public String toString() {
        return getName() + " (" + heightInInches + " inches - " + (isPreviousExperience() ? "experienced" : "inexperienced") + ")";
    }
